module fungible_token_addr::fungibleAsset {
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store::create_primary_store_enabled_fungible_asset(
            ...
            8, /* decimals */
            utf8(
                b"https://indigo-central-gibbon-526.mypinata.cloud/ipfs/QmVUWUrDen8gcLCoSCFpc5WyAdfN96wq7xqRoWSSjyGjkR"
            ),
            utf8(
                b"https://indigo-central-gibbon-526.mypinata.cloud/ipfs/QmSuPB4jkXvh7viFCZDWDMRTN53fZzGcKvjGyQs31RRbyi"
            ) /* project */
        ...
        move_to(
            ...
            ManageFungibleAsset { mint_ref, transfer_ref, burn_ref }
        );
    ...
    public fun get_metadata(): Object<Metadata> {
        ...
        let asset_address =
            object::create_object_address(&@fungible_token_addr, ASSET_SYMBOL);
