...
// module fungible_token_addr::fa_coin {
...
//         let state = borrow_global_mut<State>(object::create_object_address(&@fungible_token_addr, ASSET_SYMBOL));
...
//         let state = borrow_global<State>(object::create_object_address(&@fungible_token_addr, ASSET_SYMBOL));
...
//     #[test(creator = @fungible_token_addr, aaron = @0xface)]
